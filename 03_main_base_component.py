...
def instructions():
    print(
        """
    **** How To Play ****
    You will start by choosing the amount of questions you want to be asked, ranging from 1 - 10

    Next, you will answer these questions which will randomly be either subtraction or addition.
    
    Then after you have finished it wil display your score
    ****Good Luck!****
        """
    )
    return ""
...
questions_wanted = intcheck("How many questions do you want to be asked?: ", 1, 10)
